...
@endphp
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h2 class="single-profile-nam mb-0">Edit Profile</h2>
        <a href="{{ route('profile.show') }}" class="btn btn-outline-secondary btn-sm">Back</a>
    </div>
    ...
    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
        ...
        <div class="about-box">
            <p class="issAbout-me">Maklumat Asas</p>
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    ...
                    <select class="form-select" name="gender">
                        ...
                        <option value="">—</option>
                        <option value="male" {{ $g==='male' ? 'selected' : '' }}>Lelaki</option>
        ...
        <div class="about-box">
            ...
            <div class="text-muted small mb-2">
                Isi dalam format comma. Contoh: <b>Memasak, Hiking, Membaca</b>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <label class="form-label">Social Activities</label>
        ...
        <div class="about-box">
            <p class="issAbout-me">Gambar Profile</p>
            <div class="text-muted small mb-3">
                Max 4MB setiap gambar. Kalau nak buang gambar lama, tick “Remove”.
            </div>
                ...
                @foreach([1,2,3,4] as $i)
                    <div class="col-12">
                        <div class="p-3 border rounded-3 bg-white">
                            <div class="fw-bold mb-2">Photo {{ $i }}</div>
        ...
        <div class="about-box">
            <p class="issAbout-me">Preferences (Optional)</p>
